    ...
    <>
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="group relative w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full shadow-2xl shadow-[#25D366]/50 flex items-center justify-center transition-all duration-300 hover:shadow-[#25D366]/70"
        >
          {/* Pulsing Ring */}
          <motion.div
          ...
          <div className="relative z-10">
            <svg
              className="w-8 h-8 md:w-9 md:h-9 text-white transition-transform group-hover:scale-110"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        >
          <div className="bg-[#25D366] text-white px-4 py-2 rounded-lg shadow-xl whitespace-nowrap text-sm font-medium">
            Tire suas dúvidas
